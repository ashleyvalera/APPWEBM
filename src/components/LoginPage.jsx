    ...
    >
      <div className="w-full max-w-[420px]">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="overflow-hidden">
              {activeTab === 'login' ? (
                <div style={tabTransition}>
                  <h1 className="text-2xl font-bold text-gray-900 mb-1" style={{ fontFamily: 'Manrope, sans-serif' }}>
                    Welcome Back
                  </h1>
                  <p className="text-gray-500 text-sm mb-6">
                    Manage your health and medications with confidence.
                  </p>
                  ...
                  <form onSubmit={(e) => e.preventDefault()}>
                    ...
                    <div className="mb-4">
                      <div className="flex justify-between items-center mb-1.5">
                        ...
                        <a href="#" className="text-sm hover:opacity-80 transition-opacity" style={{ color: colors.primary }}>
                          Forgot?
                        </a>
                      </div>
                      <div className="relative">
                    ...
                    <div className="mb-6">
                      <label className="flex items-center cursor-pointer">
                        ...
                        />
                        <span className="ml-2 text-sm text-gray-600">Stay logged in for 30 days</span>
                      </label>
                    </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 py-3 px-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors"
                    >
                      <svg className="w-5 h-5" fill={colors.tertiary} viewBox="0 0 24 24">
                ...
                <div style={tabTransition}>
                  ...
                  <p className="text-gray-500 text-sm mb-6">
                    Join VitalityGuide to manage your health journey.
                  </p>
          ...
          >
            <svg className="w-5 h-5 flex-shrink-0" fill={colors.primary} viewBox="0 0 24 24">
              <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z"/>
            </svg>
            <p className="text-xs text-gray-600">
              <strong style={{ color: colors.primary }}>HIPAA Compliant:</strong> Your health data is encrypted and protected according to federal regulations.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-center gap-8 mt-8">
          <div className="flex flex-col items-center gap-2">
            <div className="w-12 h-12 rounded-xl bg-white shadow-md flex items-center justify-center">
              <svg className="w-6 h-6" fill={colors.tertiary} viewBox="0 0 24 24">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="w-12 h-12 rounded-xl bg-white shadow-md flex items-center justify-center">
              <svg className="w-6 h-6" fill={colors.secondary} viewBox="0 0 24 24">
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          © 2026 VitalityGuide. All rights reserved.
        </p>
      </div>
    </div>
  );
